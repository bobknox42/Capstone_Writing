...
```{r cross-val-selection-smape, out.width="400px", fig.align="center", fig.cap="2 4 and 6 year cross validation of Prophet models - sMAPE", echo=FALSE}
library(knitr)
include_graphics(path = "figure/Prophet_SMAPE_CV.png")
```

```{r cross-val-selection-rmse, out.width="400px", fig.align="center", fig.cap="2 4 and 6 year cross validation of Prophet models - RMSE", echo=FALSE}
library(knitr)
...
kableExtra::kable(df_sArima_Results, digit = 7, align = "r", caption = "Seasonal Arima", 
      format = "markdown", longtable = TRUE)
```
