...
```{r Quantity-Histogram, echo=FALSE, warning=FALSE,  message=FALSE, fig.cap="Histogram of Quantity", fig.width=6}
...
```{r Quantity-Time, echo=FALSE, warning=FALSE,  message=FALSE, fig.cap="Quantity over Time", fig.width=6}
library(lubridate)
library(dplyr)
library(stringr)
library(tidyr)
...
```{r Quantity-Month, echo=FALSE, warning=FALSE,  message=FALSE, fig.cap="Monthy Quantity by Year", fig.width=6}
proc_data_complete %>%
  group_by(Date)%>%
...
```{r IN-cumulative, echo=FALSE, warning=FALSE,  message=FALSE, fig.cap="Cumulative Sales by Item Number", fig.width=5}
...
```{r IN-time,echo=FALSE,warning=FALSE,  message=FALSE,fig.cap="Top 10 Item Number Quantity over Time", fig.width=5}
proc_data_complete %>%
...
```{r External-Data,echo=FALSE,warning=FALSE, message=FALSE}
library(kableExtra)
...
```{r twitter-time, out.width="400px", fig.align="center", fig.cap="CCF Google", echo=FALSE}
library(knitr)
...
```{r ccf-google, out.width="400px", fig.align="center", fig.cap="CCF Google", echo=FALSE}
library(knitr)
include_graphics(path = "figure/CCF_Google_Results.png")
```


```{r Lags-Google,echo=FALSE}
library(kableExtra)
...
```{r spacy-keyword, out.width="400px", fig.align="center", fig.cap="Spacy Keyword Vector Distance", echo=FALSE}
library(knitr)
...
```{r spacy-average, out.width="400px", fig.align="center", fig.cap="Spacy Average Tweet Vector Distance", echo=FALSE}
library(knitr)
...
```{r tweet-polarity, out.width="400px", fig.align="center", fig.cap="Textblob Tweet Polarity", echo=FALSE}
library(knitr)
